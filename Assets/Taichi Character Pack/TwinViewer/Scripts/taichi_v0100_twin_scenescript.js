...
var guiSkin            : GUISkin;
var viewCam            : taichi_v0100_twin_viewscript;
...
private var settingFileDir : String  = "Taichi_v0100/TwinViewer Settings/";
...
private var resourcesPathFull : String = "Assets/Taichi Character Pack/Resources/Taichi_v0100";
...
function Start () {
	viewCam = GameObject.Find("Main Camera").GetComponent("taichi_v0100_twin_viewscript");
...
//GUI ON OFF
var _Second_SceneScript : taichi_v0100_twin2nd_scenescript= gameObject.GetComponent("taichi_v0100_twin2nd_scenescript");
...
function SetSettings(_i:int){
	...
	switch(_i){
		// Taichi Hayami
		case 0:	
			resourcesPathFull      = "Assets/Taichi Character Pack/Resources/Taichi_v0100";	
			resourcesPath          = "Taichi_v0100/";
			animationPath          = "Taichi_v0100/Animations Legacy/m01@";
			CharacterCode          = "M01/";
			AnimationListFile      = "animation_list";
			AnimationListFileAll   = "animation_list";

			fbxCtrlSetting         = "Taichi_v0100/TwinViewer Settings/"+CharacterCode+"fbx_ctrl";
			faceMat_L              = Resources.Load("Taichi_v0100/Materials/m01_face_00_l", Material);
			faceMat_M              = Resources.Load("Taichi_v0100/Materials/m01_face_00_m", Material);
		...
		// HonokaFutaba
		case 2:
			resourcesPathFull = "Assets/HonokaFutabaBasicSet Ver1.12/Resources/Honoka_v0112";
			resourcesPath     = "Honoka_v0112/";
			animationPath     = "Honoka_v0112/Animations Legacy/f01@";
			AnimationListFile = "animation_list";
...
*/
			...
			functionList["facial"] = false;
			functionList["lod"]    = true;
			faceMat_L = Resources.Load("Honoka_v0112/Materials/f01_face_00_l", Material);
			faceMat_M = Resources.Load("Honoka_v0112/Materials/f01_face_00_m", Material);
		...
		// AoiKiryu
		case 3:
			resourcesPathFull = "Assets/Aoi Character Pack Ver1.10/Resources/Aoi_v0111";
			resourcesPath     = "Aoi_v0111/";
			animationPath     = "Aoi_v0111/Animations Legacy/f02@";
			AnimationListFile = "animation_list";
			AnimationListFileAll = "animation_list_all";
...
*/
			...
			functionList["facial"] = false;
			functionList["lod"]    = true;
			faceMat_L = Resources.Load("Aoi_v0111/Materials/f02_face_00_l", Material);
			faceMat_M = Resources.Load("Aoi_v0111/Materials/f02_face_00_m", Material);
...
*/
		...
		// Satomi Makise
		case 6:
			resourcesPathFull = "Assets/Satomi Character Pack/Resources/Satomi_v0100";	
			resourcesPath     = "Satomi_v0100/";
			animationPath     = "Satomi_v0100/Animations Legacy/f05@";
			AnimationListFile = "animation_list";
			AnimationListFileAll = "animation_list_all";
			...
			//animTest = animTestM01;
			fbxCtrlSetting    = settingFileDir+CharacterCode+"fbx_ctrl";
			faceMat_L = Resources.Load("Satomi_v0100/Materials/f05_face_00_l", Material);
			faceMat_M = Resources.Load("Satomi_v0100/Materials/f05_face_00_m", Material);
			functionList["model"]  = true;
			functionList["facial"] = false;
			functionList["lod"]    = true;
